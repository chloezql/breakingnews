...
export const supectAgentsJson = AVAILABLE_SUSPECTS.slice(0, 3).map((suspect) => ({
  ...
  Be careful not to reveal any information that would incriminate you. Background of this murder is Erin Carter, a promising young artist at the prestigious AAA Academy, was found dead in her dorm room on the eve of the annual student exhibition. `,
